                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.of(context).popAndPushNamed(sigInPageRoute);
                            },
                            child: Text(
                              "Sign In",
                      ...
                      MyTextButton(
                        buttonName: 'Register',
                        onTap: () async {
                          userValues['name'] = name.text;
                          userValues['username'] = username.text;
                          userValues['address'] = address.text;
                          userValues['password'] = password.text;
                          var result = await userService.register(userValues);
                          if(result != null){
                            ...
                            Navigator.of(context).pushReplacementNamed(HomePageRoute,arguments: result);
                          }
                        },
