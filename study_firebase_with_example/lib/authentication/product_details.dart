...
class ProductDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Product ? filteredItem = prodList.firstWhere((element) => element?.id == id, orElse: () => null);
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          actions: [
            ElevatedButton(onPressed: ()=> Provider.of<Products>(context, listen: false).updateData(id), child: Text("Update Data"))
          ],
      ),
