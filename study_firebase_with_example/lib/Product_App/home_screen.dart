...
bool _isLoading = true;
 ...
 void initState()  {
    ...
    Provider.of<Products>(context, listen: false).fetch().then((_) => _isLoading=false);
       super.initState();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child:_isLoading?const Center(child: CircularProgressIndicator(),) :prodList.isEmpty
            ? const Center(
                child: Text(
                  'No Products Added.',
                  style: TextStyle(
            ...
            : RefreshIndicator(
          onRefresh: ()async => await Provider.of<Products>(context,listen: false).fetch(),
              child: ListView(
                  children: prodList
                      .map(
                        (item) => Builder(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () =>
          Navigator.of(context).push(  MaterialPageRoute(builder: (ctx) => const AddProduct())),
